...
#generated random scanner
   ...
   def scanner
     array1=["Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Mobile/7B405","Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:25.0) Gecko/20100101 Firefox/25.0",
...
#generated random time
  def time_random
    ...
    date2=date1+$i
    $i=$i+10.0
    return Time.at(rand(date1..date2))
  end
